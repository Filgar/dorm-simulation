...
# Learning state
LEARN_BASE = 0.025   # Base knowledge gain from learning
LEARN_BONUS = 0.1  # Bonus knowledge gain from learning based on student's properties

LEARN_ENERGY_BASE_LOSS = 0.15   # Energy loss rate while learning
