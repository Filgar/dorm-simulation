...
### STATE CONFIGURATION
# Resting state
REST_BASE_GAIN = 0.15     # Base energy gain from resting (each hour)
...
KEEP_PARTYING_BASE = 0.5        # Multiplier for the probability of keeping to party below energy threshold

# Learning state
LEARN_BASE = 0.02   # Base knowledge gain from learning
LEARN_BONUS = 0.06  # Bonus knowledge gain from learning based on student's properties
...
# Party overdose
PARTY_OVERDOSE_KNOWLEDGE_LOSS = 0.5             # Percentage of knowledge lost after party overdose
