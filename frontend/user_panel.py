...
class UserPanel:
    def __init__(self):
        ...
        self.input_buffer = ""
        self.input_rect = pygame.Rect(dconfig.SCREEN_WIDTH - 120, 60, 100, 30)

        self.room_input_buffer = ""
        self.room_input_rect = pygame.Rect(dconfig.SCREEN_WIDTH - 120, 105, 100, 30)
    ...
    def draw(self, screen, dormitory):
        ...
        screen.blit(text_surface, (dconfig.SCREEN_WIDTH - dconfig.PANEL_WIDTH + 20, 20))
        ...
        screen.blit(input_desc, (dconfig.SCREEN_WIDTH - dconfig.PANEL_WIDTH + 20, 60))
        ...
        screen.blit(room_input_desc, (dconfig.SCREEN_WIDTH - dconfig.PANEL_WIDTH + 20, 105))
    ...
    def draw_selected_room_panel(self, screen, dormitory):
        ...
        screen.blit(font2.render("Students in room:", True, dconfig.BLACK), (dconfig.SCREEN_WIDTH - dconfig.PANEL_WIDTH + 20, 150))
        height = 180
